...
`course_1/chapters/<chapter>.md` is the single canonical learner-facing document for a chapter. Phase 1 creates it; Phase 2, Phase 3, and Phase 4 revise and extend that same file. Never fork a chapter into `phase2/`, `phase3/`, `*-practice.md`, or another competing Markdown source.
...
Before changing a phase status to `完成`, record in `course_1/進度.md`:
...
Maintain `course_1/進度.md` as the only authoritative progress ledger. Keep a table with all 12 chapters and separate Phase 1, Phase 2, Phase 3, and Phase 4 columns. Use `未開始`, `進行中`, `待驗收`, or `完成` exactly.
